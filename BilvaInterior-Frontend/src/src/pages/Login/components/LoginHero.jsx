// ✅ src/pages/Login/components/LoginHero.jsx
                    ...
                    <div className="col-12 col-lg-6 order-2 order-lg-1 mt-4 mt-lg-0">
                        <div className="pe-lg-4">
                                    ...
                                    <div className="d-flex align-items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <small className="text-muted">
                                                Track design → procurement → execution.
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6">
                                    <div className="d-flex align-items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <small className="text-muted">
                                                Estimate, split into phases, track costs.
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6">
                                    <div className="d-flex align-items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <small className="text-muted">
                                                Progress albums with approvals.
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6">
                                    <div className="d-flex align-items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <small className="text-muted">
                                                Share portals, POs, and invoices.
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul className="list-unstyled d-flex flex-wrap gap-3 mt-4 mb-0 check">
                                <li>
                                    <i className="bi bi-check-circle me-1"></i>Mobile-first
                                </li>
                                <li>
                                    <i className="bi bi-check-circle me-1"></i>Multi-team
                                </li>
                                <li>
                                    <i className="bi bi-check-circle me-1"></i>Secure
                                </li>
                            </ul>
                        </div>
                    </div>
