...
const EmployeesNew = () => {
    ...
    // ✅ Helper to clean and format name fields
    const formatNameInput = (rawValue) => {
        if (!rawValue) return "";
        let value = rawValue.replace(/[^A-Za-z\s]/g, "");
        if (value.length > 0) {
    ...
    // ✅ Helper to clean mobile number input
    const formatMobileInput = (rawValue) => rawValue.replace(/\D/g, "");
                        ...
                        component={(fieldRenderProps) => (
                            <FormInput
                                ...
                                onChange={(e) => {
                                    ...
                                    fieldRenderProps.onChange({ value: formatted });
                                }}
                            />
                        )}
                    />
